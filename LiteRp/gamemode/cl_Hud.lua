...
-- Door
	elseif tr.Entity:GetClass() == "func_door" or tr.Entity:GetClass() == "func_door_rotating" or tr.Entity:GetClass() == "prop_door_rotating" or tr.Entity:GetClass() == "prop_dynamic" then
		local Doorpos  = tr.Entity:GetPos()
		local Pos = LocalPlayer():GetPos()
		if Pos:Distance(Doorpos) <= 400 then
		LocalPlayer():ConCommand("GetDoorOwner")
			if DoorOwner != nil then
				draw.WordBox( 4, 400, 400, DoorOwner, "default", Color(255,255,0,150), Color(255,255,255,255) )
			else
				draw.WordBox( 4, 400, 400, "noOne", "default", Color(255,255,0,150), Color(255,255,255,255) )
			end
		end
	end
end
